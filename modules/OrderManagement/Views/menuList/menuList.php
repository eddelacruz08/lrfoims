                        ...
                        <?php foreach ($menuLists as $row) : ?>
                            <?php if($category['id'] == $row['menu_category_id']): ?>
                                <div class="col-sm-12 col-md-6 col-lg-3 col-xxl-3" id="resize-card-contents">
                                    <div class="card h-70 rounded shadow p-1" id="menu-list-hover">
                                        ...
                                        <div class="card-footer p-0">                          
                                            ...
                                            <?php else: ?>
                                                <div class="d-flex flex-column mt-0">
                                                    <input type="text" data-toggle="touchspin" id="quantity<?=$row['id']?>" min="1" max="10" onkeydown="if(event.key==='.'){event.preventDefault();}"  
