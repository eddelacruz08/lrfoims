...
function adminMenu(){
  ...
  $.ajax({
    url: "<?=base_url()?>/orders/admin-menu/admin-menu-page-reload",
    type: 'GET',
    data: {},
...
function orderTypeMenuList(){
  ...
  $.ajax({
    url: "<?=base_url()?>/orders/admin-menu/order-menu-list-data",
    type: 'GET',
    data: {},
    success: function (html) {
      element.html(html);
...
function cartRefreshAndCancelButtons(){
  ...
  $.ajax({
    url: "<?=base_url()?>/orders/admin-menu/cart-refresh-and-cancel-buttons",
    type: 'GET',
    data: {},
    success: function (html) {
      element.html(html);
