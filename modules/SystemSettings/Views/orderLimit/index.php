            ...
            <div class="card-body">
                ...
                <div id="cardCollpase1" class="collapse pt-3 show">
                    <div class="table-responsive">
                        <table class="table-hover dt-responsive nowrap w-100">
                            <thead class="thead-dark">
                                <tr>
                                    <th scope="col">
                                        <center>Order Maximum Limit</center> 
                                    </th>
                                    <th scope="col">
                            ...
                            <tbody>
                                <?php foreach ($orderLimit as $row) : ?>
                                    <tr>
                                        <th>
                                            <center><?= $row['max_limit']; ?></center>
                                        </th>
                                        <td>
                                            <center><?= $row['order_type']; ?></center>
                                        </td>
                                        <td>
                                            <center>
